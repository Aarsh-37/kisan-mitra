...
import { Settings as SettingsIcon, Globe, Mic, Bell, Shield, Info, Palette, Moon, Sun } from "lucide-react";
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-surface p-6 rounded-2xl border border-surface-light">
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <div>
                                    <h3 className="font-bold text-text">Theme</h3>
                                    <p className="text-xs text-text-secondary">App visual appearance</p>
                                </div>
                            </div>
                            <div className="grid grid-cols-2 gap-2">
                                <button
                                    onClick={() => setTheme('light')}
                                    className={`flex items-center justify-center gap-2 py-3 rounded-xl border font-bold text-sm transition-all ${theme === 'light' ? 'bg-primary border-primary text-black' : 'bg-surface-light border-surface-light text-text hover:border-primary/50'}`}
                                >
                                    <Sun className="w-4 h-4" /> Light
                                </button>
                                <button
                                    onClick={() => setTheme('dark')}
                                    className={`flex items-center justify-center gap-2 py-3 rounded-xl border font-bold text-sm transition-all ${theme === 'dark' ? 'bg-primary border-primary text-black' : 'bg-surface-light border-surface-light text-text hover:border-primary/50'}`}
                                >
